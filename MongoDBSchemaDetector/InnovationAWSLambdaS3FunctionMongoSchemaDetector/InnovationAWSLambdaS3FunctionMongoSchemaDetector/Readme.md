...
Execute unit tests
```
    cd "InnovationAWSLambdaS3FunctionMongoSchemaDetector/test/InnovationAWSLambdaS3FunctionMongoSchemaDetector.Tests"
    dotnet test
```

Deploy function to AWS Lambda
```
    cd "InnovationAWSLambdaS3FunctionMongoSchemaDetector/src/InnovationAWSLambdaS3FunctionMongoSchemaDetector"
