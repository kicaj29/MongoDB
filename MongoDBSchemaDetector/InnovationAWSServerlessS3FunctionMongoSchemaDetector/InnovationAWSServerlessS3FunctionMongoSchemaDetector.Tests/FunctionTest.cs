...
namespace InnovationAWSServerlessS3FunctionMongoSchemaDetector.Tests;
...
public class FunctionTest
{
    ...
    public async Task TestS3EventLambdaFunction()
    {
        ...
        var bucketName = "lambda-InnovationAWSServerlessS3FunctionMongoSchemaDetector-".ToLower() + DateTime.Now.Ticks;
        var key = "text.txt";
